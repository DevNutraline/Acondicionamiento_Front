...
export class ProductService extends BaseService{
  ...
  get token(): string {
    ...
    getAllWithVersions(): Observable <any> {
        let get_all_users_url = this.servicio+ 'getwithversions' 
    ...
    getProductByVersionProduct(id): Observable <any> {
    ...
    getByInvoice(id): Observable <any> {
        let get__url =this.servicio + 'getbyinvoice/' + id
        return this.http.get(this.url +get__url,{
          headers:{
            'Content-type': 'application/json',
            Authorization: `Bearer ${this.token}`
